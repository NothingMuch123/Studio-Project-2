...
void SP2::initSuperMarket()
{
	...
	pObj = new CObj(OBJ_SHELF, Vector3(0,0,0), Vector3(0,0,0), Vector3(1,1,1), Vector3(2.6,1.5,2));
	pObj->calcBound();
	objList.push_back(pObj);

	//SuperMarket Door OBJ, not suck my d*ck
